...
#           (BETA)----------
audio_lenguege = 'pt' #  deixe orig para o original
have_subtitle = True  #  coloque em string a lingua ou deixw falso
subtitle_lenguege = 'en' # subtitle language code
...
artists_urls = { # list of artists and their youtube urls
    'hacking':[
        ...
        "https://www.youtube.com/watch?v=SUhyeY0Fsvw"
    ],
    ...
    "Ivycomb":[
        ...
        'https://www.youtube.com/watch?v=eJLbw0Oq2S8&list=OLAK5uy_lUdCOhyBmC0nELUuTr6jMzaVGllIrstFU',# DATA_REJECT (all variations){MP4}
        ...
        'https://www.youtube.com/watch?v=2TrlDusx6-A'#  OUTER SKIES
        'https://www.youtube.com/watch?v=OoSvQGjvxu0'# System Error
    ...
    "Gesaffelstein":[
        'https://www.youtube.com/watch?v=co2HfQBeREY'# ALEPH
        'https://www.youtube.com/watch?v=-5z3xwSqyg4'# Aleph (sped up)
        'https://www.youtube.com/watch?v=iOxS7uIZ_es'# Aleph (slowed)
    ],

    "Hans Zimmer":[
        'https://www.youtube.com/watch?v=IXSb80MIyh4'# F1
    ],
    "Adam Jensen":[
        'https://www.youtube.com/watch?v=xBz3fHaLn4o'# Bad Day for My Enemies
    ],
    ...
    "Radiohead":[
        'https://www.youtube.com/watch?v=NUnXxh5U25Y'# Everything In Its Right Place
    ],
    
    "inverness":[
        'https://www.youtube.com/watch?v=gzr7j6y-pzk'# Breathe
    ],

    "KALEO":[
        'https://www.youtube.com/watch?v=0-7IHOXkiV8'# Way Down We Go {MP4}
    ],

    "F.O.O.L ":[
        'https://www.youtube.com/watch?v=LilMjyEcsfU'# Criminals
    ],

    "kroh":[
        'https://www.youtube.com/watch?v=XRaV5wHqS_M'# Mr. Bones
    ],

    "Jed Palmer":[
        'https://www.youtube.com/watch?v=C8qbS6ZAFO4',# The Procedure
    ],

    "Cartoon":[
        'https://www.youtube.com/watch?v=H0a111MkLds'# Why We Lose
    ],

    "Else":[
        'https://www.youtube.com/watch?v=y_zk8f6aBQk'# Paris
    ],

    "RYLLZ":[
        'https://www.youtube.com/watch?v=8IrkaczEyp4'# Nemesis
    ],

    "Tokyo Machine":[
        'https://www.youtube.com/watch?v=RhR_Z5wVvJM'# PLAY
    ],
